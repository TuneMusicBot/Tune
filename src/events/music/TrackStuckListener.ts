...
import { TrackStuckEvent } from "../../@types/lavalink";
import { EventListener } from "../../structures/EventListener";
import { Tune } from "../../Tune";
import { Node } from "../../structures/Node";
import { COLORS, CUSTOM_TYPES } from "../../utils/Constants";

export class TrackStuckListener extends EventListener {
  constructor(client: Tune) {
    super(["trackStuck"], client);
  }

  async on(packet: TrackStuckEvent, node: Node) {
